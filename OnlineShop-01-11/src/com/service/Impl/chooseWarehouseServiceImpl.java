...
public class chooseWarehouseServiceImpl implements IchooseWarehouseService {
	...
	public double getdistance(String adreess, String destination) {
		...
		System.out.println(adreess+"经度：    "+lngAndLat1.getLongitude());
		System.out.println(adreess+"纬度：    "+lngAndLat1.getLatitude());
		System.out.println(destination+"经度：    "+lngAndLat1.getLongitude());
		System.out.println(destination+"纬度：    "+lngAndLat1.getLatitude());
		return distance;
	}
	...
	for (Warehouse w : list) {
		...
		System.out.println(w.getAddress()+"距离 "+destination+": "+distance);
