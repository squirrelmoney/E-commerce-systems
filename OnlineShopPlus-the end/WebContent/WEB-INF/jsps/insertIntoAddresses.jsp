						...
						<div class="am-modal am-modal-no-btn" id="doc-modal-1">
							...
							<div class="add-dress">
								...
								<div class="am-cf am-padding">
									<div class="am-fl am-cf"><strong class="am-text-danger am-text-lg">地址管理</strong> / <small>Add&nbsp;address</small></div>
								</div>
								<hr/>

								<div class="am-u-md-12 am-u-lg-8" style="margin-top: 20px;">
									<form class="am-form am-form-horizontal" action="${pageContext.request.contextPath}/rest/addressescontroller/insertIAddresses1" method="post">
                                         <h3>添加地址</h3>
                                         
											username:<input type="text" name="username" id="username" value="${user.username }" readonly="readonly">
											address<input type="text" name="address" id="address" >
											phone:<input type="text" name="phone" id="phone" >
											name:<input type="text" name="name" id="name"  >
											<input  type="hidden" name="defaultadress" value="1" id="defaultadress" >
				...
				<ul>
					...
					<li class="person">
						<ul>
							...
							<li class="active"> <a href="${pageContext.request.contextPath}/rest/addressescontroller/customerAddress">收货地址</a></li>
							<li class="active"> <a href="${pageContext.request.contextPath}/rest/addressescontroller/insertIntoAddresses">地址管理</a></li>
						</ul>
					</li>
