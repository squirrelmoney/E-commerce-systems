...
<body>
<form  id="itemForm" action="${pageContext.request.contextPath}/rest/AdminController/saveCommndity" method="post">	
	商品名称:<input type="text" name="name">
	<br>
	<br>	
	图片:<img id='imgSize1ImgSrc' src=''  height="50" width="50" />	
		 ...
		 <!-- 返回一个相对路径放到数据库当中 -->
        <input type='hidden' id='imgSize1' name='picture' reg="^.+$" tip="亲！您忘记上传图片了。" />
	<br>
	<br>	
